...
exports.getEnemiesForZone = getEnemiesForZone;
exports.getBossForZone = getBossForZone;
...
function getEnemiesForZone(zoneId) {
    return Object.values(exports.ENEMIES).filter(e => e.zones.includes(zoneId) && !e.boss);
}
function getBossForZone(zoneId) {
    return Object.values(exports.ENEMIES).find(e => e.zones.includes(zoneId) && e.boss);
}
